...
TRAINING_ARGS = [
    ...
    [
        "custom-lr-multiplier",
        str,
        "LR multiplier sched (format: [(epoch, LR),...])",
        None,
    ],
    [
        "lr-interpolation",
        ["linear", "step"],
        "Drop LR as step function or linearly",
        "step",
    ],
    ...
    [
        "save-ckpt-iters",
        int,
        "how frequently (epochs) to save \
            (-1 for none, only saves best and last)",
        -1,
    ],
]
"""
