...
def train_model(
    ...
    *,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        acc_key = f"{'adv' if args.adv_train else 'nat'}_accuracy"
        current_val_accuracy = adv_val_accuracy if args.adv_train else nat_accuracy
        is_best = current_val_accuracy > best_accuracy
        best_accuracy = max(current_val_accuracy, best_accuracy)
        ...
        wandb_log_dict = {
            ...
            "val/adv_accuracy": adv_val_accuracy,
