...
BASE_CMD="uv run -m robustness.main --dataset cifar --data ./data/cifar --adv-train 1 --arch spectral_resnet18 --out-dir ../data/logs/checkpoints/ --epochs 10 --weight-decay 1e-2 --step-lr 2 --workers 10 --constraint random_smooth --eps 0.5 --attack-lr 1.5 --loss-type margin_barrier --batch-size 64"
